...
public class InstrumentoService {
	...
	public String uploadFile(MultipartFile file) throws IllegalStateException, IOException {
		File archivo = new File("C:\\Users\\f_erc\\Downloads\\Universidad\\Cuarto Semestre\\Laboratorio de Computacion 4\\TP9\\TP1AngularLab4\\src\\assets\\imagenes\\"+file.getOriginalFilename());
	...
	public List<InstrumentoDTO> findAll() throws Exception{
		...
		List<InstrumentoDTO> dtos = new ArrayList<InstrumentoDTO>();
		try {
	...
	public boolean delete(long id) throws Exception{
		try {
			if(repository.existsById(id)) {
				...
				File imagen = new File("C:\\Users\\f_erc\\Downloads\\Universidad\\Cuarto Semestre\\Laboratorio de Computacion 4\\TP9\\TP1AngularLab4\\src\\assets\\imagenes\\"+i.getImagen().substring(8));
				imagen.delete();
